...
do
    ...
    echo "2. Mostrar autor -l"
    echo "3. Mostrar en Columnas -C"
    echo "4. Mostrar directorio sin su contenido -d"
    echo "5. ls <directorio>"
    echo "6. Imprimir el numero de indice del archivo -i"
    echo "7. Imprimir el uid-gid -n"
    echo "8. Imprime los caracteres de control -q"
    echo "9. Imprime recursivamente -R"
    echo "0. Salir"
    echo ""
